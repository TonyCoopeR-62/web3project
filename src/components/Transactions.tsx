...
import { type StructuredTransactionScheme, TransactionContext } from '../context/TransactionContext';
...
const TransactionCard = ({ addressTo, addressFrom, timestamp, message, keyword, amount, url }: Transaction): JSX.Element => {
    ...
    <div className='flex w-full justify-center items-center 2xl:p-20 gradient-bg-transactions '>
      <div className='flex flex-col md:p-12 py-12 px-4'>
        {currentAccount
          ...
          : (
            <h3 className='text-white text-3xl text-center my-2'>
              Connect your account to see the latest transcations
            </h3>
            )}
        <div className='flex flex-wrap justify-center items-center mt-10'>
          {transactions.reverse().map((transaction: StructuredTransactionScheme, index: number) => (
